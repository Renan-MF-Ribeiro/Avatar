...
@Component({
  selector: 'app-historia-model',
  templateUrl: './historia-model.component.html',
  styleUrls: ['./historia-model.component.css']
})
export class HistoriaModelComponent implements OnInit {
